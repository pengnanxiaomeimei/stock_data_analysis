...
from shanghai_stock_exchange.stock_data_pull import get_deal_day_data, get_stock_data_list
from shanghai_stock_exchange.utils.date_utils import is_pre_day, date_parse_2_week_day, date_diff
...
stock_auto_invest_plan_list = {
    ...
    '000001': {'stock_plan_a': {'name': '每周一，周四定投', 'days': [1, 4]},
               ...
               'stock_plan_c': {'name': '每周一定投', 'days': [1]},
...
def deal_day_data_4_auto_invest_plan_a(stock_code, module=None, beg_time=None, end_time=None):
    ...
    for index in range(len(kLines)):
        ...
        if week_day == stock_plan_a_data['days'][0]:
            auto_invest_count += 1
            # 执行定投计划
            cur_auto_invest_plan_result = auto_invest_plan_a(cur_line, index, kLines, 0, 0, auto_invest_mony / 2,
